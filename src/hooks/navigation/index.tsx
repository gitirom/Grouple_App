...
export const useSideBar = (groupid: string) => {
    ...
    //once the mutation is settled or complete we invalidate the group-channel query and trigger a refetch //this makes the optimistic ui seamless => the best part of useMutation
    ...
    const { isPending, mutate, isError, variables } = useMutation({
        ...
        onSettled: async () => {
            return await client.invalidateQueries({
                queryKey: ["group-channels"],   //nvalidate the group-channel query and trigger a refetch
            })
        },
    })
