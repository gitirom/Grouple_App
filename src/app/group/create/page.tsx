...
import CreateGroup from "@/components/forms/create-groupe"
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar"
import { User } from "lucide-react"
import { redirect } from "next/navigation"


const GroupeCreatePage = async({
    searchParams
...
export default GroupeCreatePage


/* affiliate program in an LMS is essentially an upgraded marketing method where
    affiliates act as promoters for the platform or its courses. They use their 
    networks or online presence to sponsor or recommend courses, and in return, 
    they receive a commission 20% of course price */