                ...
                gallery.map((gal, key) =>
                    validateURLString(gal).type === "IMAGE" ? (
                        <img
                            onClick={() =>
                                onActive({
                                    //used to update the state of the parent component or perform some action based on the media item that was clicked. For example, it could be used to display the selected media item in a larger view, update the URL in the browser, or trigger some other functionality in the application.
                                    url: gal,
                                    type: "IMAGE",
                                })
                            }
