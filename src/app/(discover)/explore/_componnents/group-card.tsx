...
import { notFoundImage, truncateString } from "@/lib/utils"
...
type Props = {
    ...
    preview?: string
}   //ensure type safety and improve code maintainability, this makes it easier to understand what data the component requires.
...
const GroupCard = ({
    ...
    return (
        ...
        <Card className="bg-themeBlack border-themeGray rounded-xl overflow-hidden">
            <img
                src={notFoundImage || `https://ucarecdn.com/${thumbnail}/`}
                alt="thumbnail"
