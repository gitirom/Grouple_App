        ...
        case "CARD":
            return (
                <div className="flex flex-col gap-y-3 h-full bg-[#181818] rounded-xl overflow-hidden ">
                    ...
                    <SkeletonUI className="h-[200px] w-7/12 rounded-md ml-5 bg-[#202020] " />
                    <SkeletonUI className="h-[200px] w-4/12 rounded-md ml-5 bg-[#202020] " />
                </div>
            )
        case "POST":
            return (
                <div
                    className=" w-full pt-4 bg-[#1C1C1E] text-white rounded-lg border
                    Oborder-[#27272A] overflow-hidden"
                >
                    ...
                    <div
                        className="flex items-center gap-3 border-t border-[#27272A] px-6
                    py-2"
                    >
